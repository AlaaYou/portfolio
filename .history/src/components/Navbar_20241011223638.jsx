...
const Navbar = () => {
  ...
  <a 
    ...
    className="transition duration-300 ease-in-out transform hover:text-purple-300 hover:scale-110"
  >
    <FaLinkedin />
  </a>
  <a 
    ...
    target="_blank" 
    rel="noopener noreferrer"
    className="transition duration-300 ease-in-out transform hover:text-slate-300 hover:scale-110"
  >
    <FaGithub />
  </a>
  <a 
