...
export const PROJECTS = [
  {
    ...
    image: project1,
    description:
      "LaReChat is a real-time messaging platform that offers key features like real-time messaging for both users and groups, file sharing (including images, videos, audio, and PDFs), vocal messages and video/images recording,emojis and a responsive design fully functional on all devices.",
    technologies: ["React.js", "Laravel","TailwindCss","MySql"],
  },
  {
    title: "Weather App",
